...
if job_completed:
  ...
  tags += ["Coordinates: COOR3 PI: I_SAMPLE Node {0} in NSET SURFACE".format(l) for l in surface_nodes]
  ...
  cols += ["COOR3_n{0}".format(l) for l in surface_nodes]
  ...
  histDict = {
              ...
              "RF"  :"Reaction force: RF3 PI: I_INDENTER Node {0} in NSET REF_NODE".format(ref_node),
              "CF"  :"Point loads: CF3 PI: I_INDENTER Node {0} in NSET REF_NODE".format(ref_node),
              "dtip":"Spatial displacement: U3 PI: I_INDENTER Node {0} in NSET TIP_NODE".format(tip_node),
              "dtot":"Spatial displacement: U3 PI: I_INDENTER Node {0} in NSET REF_NODE".format(ref_node),   
             }
